...
ONTOLOGY_CONFIGS: Dict[str, OntologyConfig] = {
    ...
    "ai_rheum": OntologyConfig(
        acronym="AI-RHEUM",
        name="Artificial Intelligence Rheumatology Consultant System Ontology",
        disease_name="rheumatologic diagnosis",
        organ="musculoskeletal system",
        mass_location="N/A",
        class_keywords=["arthritis", "lupus", "gout", "spondylitis", "polymyalgia"],
        subtype_keywords=[],
        num_classes=6,
        # These generation fields are unused by evaluation but must be present.
        disease_symptoms=[],
        exam_templates=[],
        imaging_templates=[],
        pathology_templates=[],
        ...
        none_workup_templates=[],
        none_diagnosis_templates=[],
        rag_context_header="Relevant rheumatology classifications from AI-RHEUM:",
        positive_keywords=[
            "morning stiffness",
            "synovitis",
            "anti-ccp",
        ...
        corpus_filename="ai_rheum_corpus.jsonl",
        doc_id_field="id",
    ),
}
